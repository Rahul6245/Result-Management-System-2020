...
$db = mysqli_select_db($connection,'admit1');
 ...
 <td style="text-align:center">  <a href="dlt.php?id=<?php echo $res['id']; ?>" ><i class="fas fa-trash-alt"></i></a>   </td>
     <td style="text-align:center">  <a href="update.php?id=<?php echo $res['id']; ?>" ><i class="fas fa-user-edit"></i></a>  </td>
